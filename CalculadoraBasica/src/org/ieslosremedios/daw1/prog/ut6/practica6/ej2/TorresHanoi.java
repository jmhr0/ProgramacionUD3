...
public class TorresHanoi {
    ...
    public static void moverDiscos(int numDiscos, char torreInicial, char torreFinal, char torreAuxiliar) {
        ...
        } else { //Si hay más de un disco, la función llama a sí misma recursivamente para mover los discos
            // más pequeños de la torre inicial a la torre auxiliar, utilizando la torre final
            // como torre auxiliar. Luego, mueve el disco más grande de la torre inicial a la torre final.
            // Finalmente, la función llama a sí misma recursivamente para mover los discos más pequeños
            // de la torre auxiliar a la torre final, utilizando la torre inicial como torre auxiliar.
